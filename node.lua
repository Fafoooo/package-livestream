...
function node.render()
    ...
    -- Tick counter to verify screen updates
    local tick = math.floor(sys.now() * 10) % 100
    local debug_text = string.format("[%02d] %s", tick, last_debug_code)
    font:write(10, 10, debug_text, 40, 1, 0, 0, 1)
